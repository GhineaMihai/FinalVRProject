...
public class Door1 : MonoBehaviour
{
    ...
    public GameObject intText, standText, popupmain, popup, player;
    public bool interactable, sitting;
    public Door1 door;
    public bool locked, timeron, popped;
    public int seconds;
    float timer = 0.0f;
    public Pickup pick;
    void Start()
    ...
    void Update()
    {
        ...
        if (locked == false)
        {
            if (sitting == false && interactable == true)
            {
            ...
            if (sitting == true && interactable == true)
            {
